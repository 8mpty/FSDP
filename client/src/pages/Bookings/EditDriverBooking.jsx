    ...
    const formik = useFormik({
        ...
        onSubmit: (data) => {
            ...
            if (data.status === "Completed") {
                try {
                    const driverId = userContext.user.id;
                        ...
                        .then((driverBookingResponse) => {
                            ...
                            http
                                ...
                                .then((bookingResponse) => {
                                    ...
                                    console.log("driverId again ", driverId);
                                    // Make the POST request to create the ride history entry
                                    http
                                        .post("/ridehistory", ridehistoryData)
                                        .then((res) => {
                                            console.log(res.data);
                                        })
                                        .catch((error) => {
                                            console.error(
                                                "Error creating ride history entries",
                                                error
                                            );
                                        });
                                })
...

                        {
                            driverbooking.status === "Accepted" && (
                                ...
                                >
                                    ...
                                    {
                                        completeoptions.map((completeoption) => (
                                            <MenuItem key={completeoption.value} value={completeoption.value}>
